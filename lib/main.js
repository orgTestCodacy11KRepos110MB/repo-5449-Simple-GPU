...
async function makePipeline(state) {
  ...
  [
    {
      arrayStride: 4 * state.options.attributes.position[0].length, //two vertices so 4 bytes each
      attributes: [
        {
          // position
          shaderLocation: 0,
  ...
  [
    {
      arrayStride: 4 * state.options.attributes.position[0].length, //inspect array vertices and say 10 elements per array * 4 bytes
      attributes: [
        {
          // position
          shaderLocation: 0,
